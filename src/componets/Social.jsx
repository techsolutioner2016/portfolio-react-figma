...
const SocialLinks = () => {
    const links = [
        ...
        href: 'https://twitter.com/techsolutioner2016',
        },
        {
        id: 2,
        child: (
        ...
        href: 'https://github.com/techsolutioner2016',
        },
        {
        id: 3,
        child: (
        ...
        href: 'https://www.linkedin.com/in/techsolutioner2016/',
        style: 'rounded-tr-md'
        },
        {
        id: 4,
        ...
        href: 'mailto:techsolutioner2016@outlook.com',        
        },
    ]
